...
/*
 * @brief	Sends AT command to SIM808 and waits for response
...
// this function is for testing and it's resp1 and resp2 in SendATCommand are wrong
SIM808Status SIM808_Dial (uint32_t timeout_ms)
{
	...
	status = SIM808_SendATCommand (tempStr, "\r\nNO CARRIER\r\n", "\r\nOK\r\n", timeout_ms);
